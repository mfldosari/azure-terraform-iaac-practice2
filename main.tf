...
module "compute" {
  ...
  streamlit_custom_name = var.streamlit_custom_name
  streamlit_custom_rg_name = var.streamlit_custom_rg_name
  chroma_custom_name = var.chroma_custom_name
  chroma_custom_rg_name = var.chroma_custom_rg_name
